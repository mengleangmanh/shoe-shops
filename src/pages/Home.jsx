...
export default function Home() {
  return (
    <div className="bg-cover bg-center h-screen background-size-700 background-size: auto; bg-[url('https://saysh.com/cdn/shop/files/01_Saysh-Shoes_041_1.webp?v=1707541464&width=5760')] ">
